...
urlpatterns = [
    ...
    path('weekly_active_players', views.get_weekly_active_players),  # TO_REDO
    path('active_players', views.get_active_players),                               # INSERTED
    path('daily_playtime', views.get_daily_playtime),                               # INSERTED
    path('customer_churn_rate', views.get_ccr),  # TO_REDO
    path('new_player_per_day', views.get_new_players_per_day),  # TO_REDO
    path('game_session_frequency', views.get_game_session_frequency),               # INSERTED
    path('player_retention_rate', views.get_player_retention_rate),  # TO_REDO
    path('all_users', views.get_all_users),                                         # INSERTED

    path('diet_evolution', views.get_diet_evolution_per_player),  # TO_REDO
